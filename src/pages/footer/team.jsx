...
const Team = () => {
  ...
  return (
    <>
      <Helmet titleTemplate="%s | L'équipe">
        <title>MENU</title>
        <meta name="description" content="Page qui présente les membres de l'équipe qui a crée ce site." />
      </Helmet>
      ...
      <div className="team-cards">
        <div className="card-team">
          <div className="card-info-team">
            ...
            <div className="card-title-team"> Anelise </div>
            <div className="card-subtitle-team"> {t('founder')} </div>
          </div>
        ...
        <div className="card-team">
          <div className="card-info-team">
            <div className="card-avatar-team"></div>
            <div className="card-title-team"> Benedicte </div>
            <div className="card-subtitle-team"> {t('founder')} </div>
          </div>
          <ul className="card-social">
            <li className="card-social__item">
        ...
        <div className="card-team">
          <div className="card-info-team">
            <div className="card-avatar-team"></div>
            <div className="card-title-team"> Nicolas V. </div>
            <div className="card-subtitle-team"> {t('founder')} </div>
          </div>
          <ul className="card-social">
            <li className="card-social__item">
